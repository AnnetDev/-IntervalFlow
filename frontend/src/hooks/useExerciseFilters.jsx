// Consider passing icon component references (e.g. icon: ChartNoAxesColumnIncreasing)
// instead of JSX elements, and let the consuming component handle rendering.
// This keeps the hook as a pure data/logic layer and allows renaming to .js.
...
export function useExerciseFilters(exercises = []) {
    ...
    const selectOptions = useMemo(() => {
        function getOptions(field) {
            const unique = [
                ...new Set(exercises.map((ex) => ex[field]).filter(Boolean)),
            ];
            return [
