...
// Five interdependent state variables updated together — consider useReducer for clearer state transitions
    ...
    function goBack() {
        if (phase === 'rest') {
            ...
            if (currentExercise === 1 && currentRound === 1) {
                // Empty branch — no-op at the start; consider an early return for clarity
